      ...
      <div>
        ...
        <table className="subgeography-totals subgeography-totals--causes-of-change">
          ...
          <tbody>
            ...
            <tr className="subgeography-totals__totals" key="totals">
              <td className="subgeography-totals__subgeography-name">Totals</td>
              <td>{formatNumber(change_totals.ESTIMATE)}</td>
              <td>{formatNumber(change_totals.GUESS_MIN)}</td>
              <td>{formatNumber(change_totals.GUESS_MAX)}</td>
              <td>{formatNumber(change_totals.RANGE_AREA)}</td>
              <td>{formatNumber(change_totals.PERCENT_OF_RANGE_ASSESSED)}</td>
            </tr>
          </tbody>
        </table>
      </div>
...
CountsBySurveyCategory.propTypes = {
  ...
  change_totals: PropTypes.object.isRequired,
